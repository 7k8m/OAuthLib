...
namespace OAuthLib
{
    ...
    public class Consumer
    {
        ...
        /// <param name="queryParameters">Query parameter to be sent</param>
        /// <param name="additionalParameters">Parameters added to Authorization header</param>
        /// <param name="createRequest" >Factory method to create reuest object</param>
        /// <returns>HttpWebResponse from protected resource</returns>
        public HttpWebResponse  AccessProtectedResource(
            AccessToken accessToken,
            String urlString,
            ...
            Parameter[] queryParameters,
            Parameter[] additionalParameters,
            RequestFactoryMedthod createRequest){
        ...
        /// <summary>
        /// User can specify the factory method for creating request instance when calling AccessProtectedResource/BeginAccessProtectedResource 
        /// passing RequestFactoryMethod delegate.
        /// Specifying the delegate, user can access much of the HttpWebRequest object.
        /// </summary>
        public delegate HttpWebRequest RequestFactoryMedthod(String uri);
